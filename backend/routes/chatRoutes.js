...
router.post("/plans", (req, res) => {
  ...
  const systemContent = isPlans
    ? "You are a support assistant for SharyX OCR. Answer questions about plans and pricing.\n\nPlans:\n- Free: Rs.0/mo — 5 summaries/day, 10MB max\n- Pro: Rs.499/mo — 15/day, 50MB, all AI models\n- Enterprise: Rs.1999/mo — Unlimited, 200MB, bulk processing\nAll prices include 18% GST. Razorpay payments. Daily limits reset midnight."
    : "You are a billing assistant for SharyX OCR. Help with invoices, subscriptions, and payments. All prices in INR+18% GST. Razorpay payments.";
