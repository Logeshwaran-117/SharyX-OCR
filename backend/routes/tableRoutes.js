...
const { suggestTableFields, suggestTableFieldsFromImage, callWithRotation, GEMINI_MODEL } = require("../services/geminiService");
...
Answer:`;
    ...
    let answer;
    try {
      answer = await callWithRotation(() => [{ text: prompt }], 2048, GEMINI_MODEL);
